            ...
            <div class="flex flex-col w-full mb-12 text-left lg:text-center">
                ...
                <div class="flex flex-col w-full mb-12 text-left lg:text-center">
                    <table class="table-auto w-full text-left whitespace-no-wrap">
                        <thead>
                            <tr>
                                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 dark:bg-slate-700 dark:text-white text-sm bg-gray-100 rounded-tl rounded-bl">Hop</th>
                                ...
                                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 dark:bg-slate-700 dark:text-white text-sm bg-gray-100">Ping 3</th>
                            </tr>
                        </thead>
